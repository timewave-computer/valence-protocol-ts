...
type ValenceDomainModalProviderProps = Omit<ComponentProps<typeof DomainModalProvider>, 'config'>
...
export const ValenceDomainModalProvider = ({ children, ...rest }: ValenceDomainModalProviderProps) => {
  return <DomainModalProvider config={domainClientsConfig} {...rest}>{children}</DomainModalProvider>;
};