...
export const evmUsdc = {
  chainId: mainnet.id,
  symbol: 'USDC',
  tokenAddress: '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48' as EvmAddress,
};

export const evmUser: EvmAddress = '0x98C23E9d8f34FEFb1B7BD6a91B7FF122F4e16F5c'; // AAVE protocol
